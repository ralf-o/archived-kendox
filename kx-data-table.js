(function () {
    ...
    $.fn.kxDataTable = function (config) {
        if (this.size() === 1) {
    ...
    createTableBody = function (tableParams) {
        ...
        if (records instanceof Array || records instanceof kendo.data.ObservableArray) {
           for (var i = 0; i < records.length; ++i) {
               ...
               $('<td class="xk-header kx-data-table-meta-column"/>').append('<button class="k-button kx-data-table-row-details-toggle">+</button>').appendTo(tr);            

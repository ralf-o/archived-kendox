(function () {
    var kendox = window.kendox = window.kendox || {},
        util = kendox.util = kendox.util || {},
        ui = kendox.ui = kendox.ui || {};
  
    util.Objects = function () {
        throw 'kendox.util.Strings cannto be instantiated';
    };
    
    util.Objects.toString = function () {
        return '<kendox.util.Objects>';
    };
    ...
    util.Arrays = function () {
        throw 'kendox.util.Arrays cannot be instantiated';
    }
    
    util.Arrays.toString = function () {
        return '<kendox.util.Arrays>';
    }
    ...
    ui.Dialogs = function () {
        throw 'kendox.ui.Dialogs cannot be instantated';
    };
    
    
    ui.Dialogs.toString = function () {
        return '<kendox.util.Dialogs>';
    };
